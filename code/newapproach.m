...
% elsolver=@(a) minsolving(Temp,a,fs_data);
% 
% options = optimoptions('fsolve','MaxFunctionEvaluations',1E4,'MaxIterations',1E4)
% respuesta = fsolve(elsolver,a0,options)
% 
% plot(Temp,fs_data,Temp,fs(Temp,respuesta))
